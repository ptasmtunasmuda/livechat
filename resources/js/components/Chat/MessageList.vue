            ...
            >
                ...
                <div class="flex-1 max-w-xs lg:max-w-md">
                    ...
                    >
                        ...
                        >
                            <div class="text-xs opacity-75">Replying to: {{ getReplyContent(message.metadata.reply_to) }}</div>
                        </div>
                        ...
                        <div v-if="editingMessage === message?.id">
                            ...
                            <div class="flex justify-end space-x-2 mt-2">
                                <button @click="saveEdit(message.id)" class="text-xs underline opacity-75 hover:opacity-100">Save</button>
                                <button @click="cancelEdit" class="text-xs underline opacity-75 hover:opacity-100">Cancel</button>
                            </div>
                        </div>
                        <div v-else>
